    ...
    class DatabaseInitializer : System.Data.Entity.DropCreateDatabaseAlways<GottaHaveItContext>//DropCreateDatabaseIfModelChanges<GottaHaveItContext>
    {
        ...
        protected void SeedLocations()
        {
            var locations = new List<Location>
            {
                ...
                new Location {Name="Darien Lake Performing Art Center", Description="The Darien Lake Performing Arts Center was opened in the 1990s as a replacement for the Lakeside Amphitheater concert venue. The PAC, as it is commonly referred to, is operated by Live Nation and owned by CNL. Tickets for these events can be upgraded to Park Combo Passes or bought without park admission. The amphitheater has a full capacity of 21,600.", AddrLine1= "9993 Allegheny Road",  City="Darien Center", State="NY", ZipCode="14040", PhoneNumber="2017440770"}
            };
